...
%   include:
%       - plotMovie: 
classdef (Abstract) CableWrappingMotionSimulatorBase_v0 < SimulatorBase
    ...
    methods
        ...
        function ms = CableWrappingMotionSimulatorBase_v0(model, view_angle, fig_handle, axis_handle)
...
%             Plot frame at CoM
            for k = 1:1
                ...
                T_g_r      = wrap_model_config.frame_info.Links.TransformationMatrices{1}.T_g_r;
                
                frame_r_r  = [[0.1*eye(3,3); 1, 1, 1]';0 0 0 1]';
                frame_r_g  = T_g_r*frame_r_r;
                frame_r_g(1:3,1:3) = frame_r_g(1:3,1:3);

                frame_r_g_origin = wrap_model_config.frame_info.frame_r{1}.origin_r_g(1:3);
...
%                 for i = [1 2 3 4 ]
%                     if wrap_model_config.wrap_info.wrap_state(i) == 0
%                         plot3(wrap_model_config.cable_info.cable{i}.cable_wrapping_curve.alpha_val_c_g(:,1),...
%                         wrap_model_config.cable_info.cable{i}.cable_wrapping_curve.alpha_val_c_g(:,2),...
%                         wrap_model_config.cable_info.cable{i}.cable_wrapping_curve.alpha_val_c_g(:,3), 'LineWidth',2, 'Color', 'k');
%                     else
%                         if wrap_model_config.obstacle_detection_info.obstacle_detection_state(i)
%                             plot3(wrap_model_config.cable_info.cable{i}.obstacle_cable_wrapping_curve.alpha_val_obs_g(:,1),...
%                         wrap_model_config.cable_info.cable{i}.obstacle_cable_wrapping_curve.alpha_val_obs_g(:,2),...
%                         wrap_model_config.cable_info.cable{i}.obstacle_cable_wrapping_curve.alpha_val_obs_g(:,3), 'LineWidth',2, 'Color', 'k');
%                         else
%                             plot3(wrap_model_config.cable_info.cable{i}.cable_wrapping_curve.alpha_val_c_g(:,1),...
