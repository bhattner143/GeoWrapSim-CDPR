...
classdef CableWrappingInverseDynamicsSimulatorBezier < CableWrappingDynamicsSimulatorBezier
    ...
    methods
        ...
        function id = CableWrappingInverseDynamicsSimulatorBezier(wrap_model_config, id_solver, lb, ub, friction_model)
