...
classdef CableWrappingDynamicsSimulator < CableWrappingOptimizer
    ...
    methods   
        ...
        function ds = CableWrappingDynamicsSimulator(wrap_model_config)
            ds@CableWrappingOptimizer(wrap_model_config);
        end
