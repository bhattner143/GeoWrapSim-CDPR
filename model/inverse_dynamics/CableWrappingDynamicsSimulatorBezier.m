...
classdef CableWrappingDynamicsSimulatorBezier < CableWrappingOptimizerBezier
    ...
    methods   
        ...
        function ds = CableWrappingDynamicsSimulatorBezier(wrap_model_config)
            ds@CableWrappingOptimizerBezier(wrap_model_config);
        end
