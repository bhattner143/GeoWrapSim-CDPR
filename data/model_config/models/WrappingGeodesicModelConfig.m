...
% frame m            CoM frame
classdef WrappingGeodesicModelConfig < ModelConfigBase    
    properties  
        userDefined_P
        y_A_b = []
        phi_A_b =[]
...
%         obstacle_height = 0.20;
    ...
    methods
        ...
        % objects.
        function obj = WrappingGeodesicModelConfig(type_string, surface_type , userDefined_P, viewRotm, obs_surface_type)
...
%           % CoM (need to check this part)
        ...
        function UpdateHelicalWrappingParams(obj, b,k, check_helix, cable_indices, opt)
         ...
         %% Update cable wrapping parameters wrt param blambda_obs_array and k
