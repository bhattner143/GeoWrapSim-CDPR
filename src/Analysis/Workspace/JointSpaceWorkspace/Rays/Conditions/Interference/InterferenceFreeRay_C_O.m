...
classdef InterferenceFreeRay_C_O < WorkspaceRayConditionBase
    properties (SetAccess = protected, GetAccess = protected)
        ...
        box                         % the index of segments to be evaluated
    end
    
    methods
        % Constructor for interference free worksapce
        function w= InterferenceFreeRay_C_O(min_ray_percent,box)
