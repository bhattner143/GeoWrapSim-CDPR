...
classdef InverseDynamicsSimulator < DynamicsSimulator
    ...
    methods
        ...
        function verifyEoMConstraint(obj, plot_axis)
            ...
            for t = 1:length(obj.timeVector)
                obj.model.update(obj.trajectory.q{t}, obj.trajectory.q_dot{t}, obj.trajectory.q_ddot{t},zeros(3,1));
            ...
            if nargin <= 1 || isempty(plot_axis)
                ...
                figure; plot(obj.timeVector, w_right, 'LineWidth', 2, 'Color', 'r'); title('ID verify w right hand side');
            else
