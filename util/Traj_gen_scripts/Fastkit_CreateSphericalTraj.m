...
b = 0.1;
x = 1.0*radius*sin(phi./(2*n_loops)).*sin(phi) + center(2)-0.4;
y=radius*sin(phi./(2*n_loops)).*cos(phi) + center(1)-2+0.5;
z=0.5*radius*cos(phi./(2*n_loops)) + center(3)-1+2-1+0.3;
