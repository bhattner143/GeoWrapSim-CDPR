...
classdef CableWrappingIDSolverQuadProgBezier < IDSolverBaseCW
    ...
    methods
        ...
        function id = CableWrappingIDSolverQuadProgBezier(model, objective, qp_solver_type)
            id@IDSolverBaseCW(model);
