...
classdef MyoInterface < CableActuatorInterfaceBase
    properties (Access = private)        
        ...
        %trying to access length in matlab directly
        length_sub;                   % pose subscriber
        length_msg;                   % pose message
    end
    ...
    properties (Access = private, Constant = true)  
        ...
        % Accesing topic-->/myomuscle_feedback 
        length_topic = '/myomuscle_feedback';
        length_msg_type = 'myo_manager/Feedback';
    ...
    methods
        ...
        % subscribe length information
        function [length_feedback] = lengthFeedbackRead(obj) 
            obj.length_msg = obj.length_sub.LatestMessage;
            while isempty(obj.length_msg)
                obj.length_msg = obj.length_sub.LatestMessage;
            end        
            length_feedback = obj.length_msg.length; 
            obj.length_msg = [];
        end  
