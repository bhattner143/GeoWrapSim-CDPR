...
% load saved ik model
file_loc = 'D:\MATLAB\CASPR_private_dips_wrapping\scripts\local\CASPR_private_scripts\members\Dipankar\Myo_Hardware_BMWrapArm\Almond_Cylinder_16_03_23\'
% model_file_name = 'model_ik_traj_roll_0pt8.mat';
% model_file_name = 'model_ik_traj_pitch_0pt4_4s.mat';
model_file_name   = 'Result_model_ik_traj_yaw_2';
...
% model_file_name = 'Result_model_ik_traj_triangle_motion';
% model_file_name   = 'Result_model_ik_traj_origin';
...
for ii = 1:size(t,1)
    ...
    l_cmd = [l_cmd_geo l_cmd_geo(2) l_cmd_geo(4)]' - [0.0416, 0.0610, 0.3180+0.0025, 0.0668, 0,0]';
