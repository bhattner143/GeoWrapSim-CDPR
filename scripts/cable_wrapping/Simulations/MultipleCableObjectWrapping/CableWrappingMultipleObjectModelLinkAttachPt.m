...
classdef CableWrappingMultipleObjectModelLinkAttachPt < handle
    ...
    methods
        %%
        function obj = CableWrappingMultipleObjectModelLinkAttachPt(object_prop, P,A)
            ...
            % Initialize bounds
            obj.lb_obs_obj(1, 1) = 0.00;
            obj.lb_obs_obj(2, 1) = 0.00;
            obj.lb_obs_obj(3, 1) = 0.00001;
            obj.lb_obs_obj(4, 1) = -1;
            
            obj.ub_obs_obj(1, 1) = 0.2;
            obj.ub_obs_obj(2, 1) = 2*pi;
            obj.ub_obs_obj(3, 1) = 2;
            obj.ub_obs_obj(4, 1) = -0.000001;

            obj.lb_obs_obj(1, 2) = 0.00;
            obj.lb_obs_obj(2, 2) = 0.00;
            obj.lb_obs_obj(3, 2) = 0.0001;
            obj.lb_obs_obj(4, 2) = -1;

            obj.ub_obs_obj(1, 2) = 0.2;
            obj.ub_obs_obj(2, 2) = 2*pi;
            obj.ub_obs_obj(3, 2) = 2;
            obj.ub_obs_obj(4, 2) = -0.000001;
            % 
            ...
            % obj.lb_obs_obj(1, 3) = 0.00;
            % obj.lb_obs_obj(2, 3) = -pi;
            % obj.lb_obs_obj(3, 3) = 0.001;
            % obj.lb_obs_obj(4, 3) = -1;
            % % 
            % obj.ub_obs_obj(1, 3) = 0.3;
            % obj.ub_obs_obj(2, 3) = 2*pi;
            % obj.ub_obs_obj(3, 3) = 1;
            % obj.ub_obs_obj(4, 3) = -0.0001;
            % 
            obj.lb_obs_obj(1, 3) = -0.1;
            obj.lb_obs_obj(2, 3) = -pi;
            obj.lb_obs_obj(3, 3) = -0.09;
            obj.lb_obs_obj(4, 3) = -2;

            obj.ub_obs_obj(1, 3) = 0.3;
            obj.ub_obs_obj(2, 3) = 2*pi;
            obj.ub_obs_obj(3, 3) = 1;
            obj.ub_obs_obj(4, 3) = 1;
            ...
            for obj_num = 1:obj.tot_num_objs
                ...
                elseif obj_num < 6 && obj_num > 1 % Other objects
                    ...
                    if  strcmp(obj.object_prop(index).type,'cylinder')
                        ...
                        objects(obj_num).object.du     = obj.CreateCWG(obj.f_R_cyl_cwg);
                    ...
                    elseif strcmp(obj.object_prop(index).type,'cone')
                        ...
                        objects(obj_num).object.f_R_val = f_R_val;
                        objects(obj_num).object.du     = obj.CreateCWG(obj.f_R_cone_cwg);;
        ...
        %     obj_num = 2;
            for obj_this = 2:num_of_obj_in_map - 1
                ...
                elseif strcmp(obj.object_connection_map(obj_this).object.type, 'cone')
                    [tt, uv] = ode45(@(t,u)obj.object_connection_map(obj_this).object.du(u(1),u(2),u(3),u(4),...
                        obj.object_connection_map(obj_this).object.alp,...
                        obj.object_connection_map(obj_this).object.d),...
                        obj.tspan, [u0,v0,udot0,vdot0]);
                end
