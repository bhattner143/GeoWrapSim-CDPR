...
cableLengthData      =  ik_sim.cableLengthTotGeo                + c_err*randn(n_r_l,n_c_l);
...
% RMSE
rmse_q_est = sqrt(vecnorm(errorVector_length)/length(errorVector_length));
...
close all
fig_path = 'F:\MATLAB_Drive\CASPR_private_dips_wrapping\scripts\local\CASPR_private_scripts\members\Dipankar\Simulations\BMWrapArm\Figure\Almond\2023_07_15\'
