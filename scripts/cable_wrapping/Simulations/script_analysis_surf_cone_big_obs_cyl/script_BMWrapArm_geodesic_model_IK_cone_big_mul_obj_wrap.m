...
wrap_optimizer_with_gen_int_det = CWOptWithGenIntDet(wrap_model_config);

% Generate wrap optimizer model for all cables
...
% 
% %plot
wrapping_case    = wrap_optimizer.wrapping_case;
wrap_optimizer.PlotFrame(wrap_optimizer.model_config, wrapping_case,[144.939999703765 18.3043112068588]);
fig_kinematics = gcf;
axes_kinematics = gca;
